...
class POP3
{
   ...
   * @return boolean
   */
  public static function popBeforeSmtp($host, $port = false, $timeout = false, 
   ...
   * @return boolean
   */
  public function authorise($host, $port = false, $timeout = false, $username = '', 
  ...
  public function connect($host, $port = false, $tval = 30)
  {
    ...
    // On Windows this will raise a PHP Warning error if the hostname doesn't
    // exist.
